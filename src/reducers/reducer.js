...
import {TEST_FETCH_INVOICES_REQUEST} from '../actions/testFetchInvoicesRequest'
import {TEST_FETCH_INVOICES_SUCCESS} from '../actions/testFetchInvoicesSuccess'
...
const reducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case TEST_FETCH_INVOICES_REQUEST:
            return {
                ...state,
                loading: true
            }

        case TEST_FETCH_INVOICES_SUCCESS:
            return {
                ...state,
                invoices: action.invoices,
                loading: false
